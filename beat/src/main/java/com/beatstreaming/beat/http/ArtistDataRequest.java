...
public class ArtistDataRequest extends HttpRequestBinding<ArtistEntity, ArtistPageBinding, ArtistSectionListBinding> {
    ...
    private final PlayableSectionListBinder playableSectionListBinder;

    @SneakyThrows
    public ArtistDataRequest(Context context, ArtistPageBinding artistPageBinding, AppSourceEntity appSourceEntity, ArtistPayload artistPayload, ArtistSectionListBinding artistSectionListBinding, PlayableSectionListBinder playableSectionListBinder) {
        ...
        this.playableSectionListBinder = playableSectionListBinder;
    ...
    public void onLoad(ArtistEntity artistEntity) {
        ...
        this.resultBinding.sectionList.setAdapter(new ListRecyclerViewAdapter(new SectionPlayerContext(this.appSourceEntity, new ArtistPlayerSource(artistEntity)), artistEntity.getSections(), this.playableSectionListBinder));
