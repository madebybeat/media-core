...
@AndroidEntryPoint
public class AppLoadableAlbumPage extends LoadableArtistPage {
    @Inject SectionListBinder sectionListBinder;

    public AppLoadableAlbumPage(AppSourceListContext appSourceContext, ArtistEntity artistEntity) {
