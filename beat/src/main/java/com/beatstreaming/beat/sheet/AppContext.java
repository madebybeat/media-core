...
public class AppContext extends ListSheetItemContext<PlayContext, LibraryItemEntity<TrackEntity>> {
    public AppContext() {
    ...
    @Override
    public String getTitle(Context context, ListSheetContext<PlayContext, LibraryItemEntity<TrackEntity>> listSheetContext) {
