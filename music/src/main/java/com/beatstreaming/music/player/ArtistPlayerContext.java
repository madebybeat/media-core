...
public class ArtistPlayerContext extends MusicPlayerContext<SectionEntity> {
    public ArtistPlayerContext(AppSourceEntity appSourceEntity, PlayerSource<SectionEntity> playerSource) {
