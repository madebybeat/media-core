...
public class MediaListItemBinder<C extends ListContext, T extends MediaItemEntity, V extends ItemEntity> extends ItemListItemBinder<C, T> implements ItemSetup<MediaListItemBinder<C, T, V>, PlayerContext<V, T>> {
