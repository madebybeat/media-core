...
public class MediaListItemBinder<C extends ListContext, T extends VideoEntity, V extends ItemEntity> extends ItemListItemBinder<C, T> implements ItemSetup<MediaListItemBinder<C, T, V>, PlayerContext<V, T>> {
