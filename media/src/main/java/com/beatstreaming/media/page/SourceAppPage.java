...
public class SourceAppPage extends HttpRequestPage<AppSourceListEntity> {
    ...
    @Inject
    AppSourceBinder appSourceItemBinder;
    ...
    public void onLoad(AppSourceListEntity appSourceListEntity) {
        this.sourceAppPageBinding.sourceAppList.setAdapter(new ListRecyclerViewAdapter<ListContext, AppSourceBinder>(null, appSourceListEntity, this.appSourceItemBinder));
    }
}
