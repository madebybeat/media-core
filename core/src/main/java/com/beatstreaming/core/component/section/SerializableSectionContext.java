...
public class SerializableSectionContext extends ListSectionContext<ListContext, SectionEntity> {
    public SerializableSectionContext(Context context, ListContext listContext, SectionEntity sectionEntity) {
        super(context, sectionEntity.getName(), new ListRecyclerViewAdapter<ListContext, SectionEntity>(listContext, sectionEntity, new SectionListBinder()));
    }
}
