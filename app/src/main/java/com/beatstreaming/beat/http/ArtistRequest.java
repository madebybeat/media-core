...
public class ArtistRequest extends HttpRequestBinding<SearchResultEntity, ArtistPageBinding> {
    private final AppSourceEntity appSourceEntity;

    private final TrackListImageItemBinder trackListItemBinder;

    @SneakyThrows
    public ArtistRequest(Context context, ArtistPageBinding artistPageBinding, AppSourceEntity appSourceEntity, ArtistPayload artistPayload, SearchPageResultBinding searchPageResultBinding, TrackListImageItemBinder trackListItemBinder) {
        super(context, artistPageBinding.artistTracksList, artistPageBinding, SearchResultEntity.class, Request.Method.GET);
    ...
    public void onLoad(SearchResultEntity searchResultEntity) {
        this.binding.artistTracksList.init(new SearchTrackSectionContext(this.context, new AppSourceContext(this.appSourceEntity), searchResultEntity.getTracks(), this.trackListItemBinder));
